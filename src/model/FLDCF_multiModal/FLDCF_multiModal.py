...
class Embeddings(nn.Module):
    ...
    def forward(self, x, y):
        ...
        # return x, y, features,  res2, size_conv1 ###
...
class Transformer(nn.Module):
    ...
    def forward(self, input_ids, dsm_ids):
        ...
        # embeddingsx, embeddingsy, features, res2, size_conv1 = self.embeddings(input_ids, dsm_ids) ###
        encodedx, encodedy, attn_weights = self.encoder(embeddingsx, embeddingsy)  # (B, n_patch, hidden) ## Global Feature Block of Encoder
        # encodedx, encodedy, attn_weights = self.encoder(input_ids, dsm_ids) ###
