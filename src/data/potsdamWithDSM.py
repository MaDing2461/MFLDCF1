...
# real dsm
    def _set_filesystem(self, dir_data):
        ...
        self.dir_lr_gt = os.path.join(self.apath, 'train/gt')
        self.dir_lr_dsm = os.path.join('/media/lscsc/nas/mading/data/fake_Potsdam_dsm', 'train/gt_generated_place') #
        # self.dir_lr_dsm = os.path.join(self.apath, 'train/inpainted') ##
        # /media/lscsc/nas/mading/data/fakeV_dsm/train/gt_geanerated_place
        self.dir_lr_gt_dsm = os.path.join('/media/lscsc/nas/mading/data/fake_Potsdam_dsm', 'train/gt_dsm') #
        # self.dir_lr_gt_dsm = os.path.join(self.apath, 'train/gt') ##


        self.dir_test_hr = os.path.join(self.apath, 'test/inpainted_mask')
        self.dir_test_lr = os.path.join(self.apath, 'test/repaint') #'test/lama'  inpainted  repaint
        self.dir_test_lr_gt = os.path.join(self.apath, 'test/gt')
        self.dir_test_lr_dsm = os.path.join('/media/lscsc/nas/mading/data/fake_Potsdam_dsm', 'test/gt_generated_place') # gt_generated_place
        # self.dir_test_lr_dsm = os.path.join(self.apath, 'test/repaint') ##
        # /media/lscsc/nas/mading/data/fakeV_dsm/test/gt_generated_place
        self.dir_test_lr_gt_dsm = os.path.join('/media/lscsc/nas/mading/data/fake_Potsdam_dsm', 'test/gt_dsm') #
