...
class Fake_Vaihingen_Vehicle(SRData):
    ...
    def _set_filesystem(self, dir_data):
        ...
        self.dir_hr = os.path.join(self.apath, 'train/repaint_mask_20pixel_enlargement_toEveryDirection')
        self.dir_lr = os.path.join(self.apath, 'train/repaint_inpaint_20pixel_enlargement_toEveryDirection')
        self.dir_lr_gt = os.path.join(self.apath, 'train/gt')

        self.dir_test_hr = os.path.join(self.apath, 'test/repaint_mask_20pixel_enlargement_toEveryDirection')
        self.dir_test_lr = os.path.join(self.apath, 'test/repaint_inpaint_20pixel_enlargement_toEveryDirection')
        self.dir_test_lr_gt = os.path.join(self.apath, 'test/gt')
