        ...
        if args.ext.find('img') >= 0 or benchmark:
            ...
            if train:  #训练集和测试集分开
                ...
                if args.dsm_option == True:
                    os.makedirs(
                        os.path.join(
                            self.dir_lr_dsm.replace('/media/lscsc/nas2/mading/data/fake_Vaihingen_vehicle_DSM/bin', path_bin), #self.dir_lr_dsm = os.path.join('/media/lscsc/nas/mading/data/fakeV_dsm', 'train/inpainted_gray')
                            'X{}'.format(args.scale)
                        ),
                        exist_ok=True
                    )
                ...
                if args.dsm_option == True: 
                    for i, l in enumerate(list_dsm):
                        # print(self.apath)
                        # print(path_bin)
                        b = l.replace('/media/lscsc/nas2/mading/data/fake_Vaihingen_vehicle_DSM/bin', path_bin)
                        b = b.replace(self.ext[1], '.pt')
                ...
                if args.dsm_option == True:
                    os.makedirs(
                        os.path.join(
                            self.dir_test_lr_dsm.replace('/media/lscsc/nas2/mading/data/fake_Vaihingen_vehicle_DSM/bin', path_bin), #self.dir_test_lr_dsm = os.path.join('/media/lscsc/nas/mading/data/fakeV_dsm', 'test/inpainted_gray')
                            'X{}'.format(args.scale)
                        ),
                        exist_ok=True
                    )
